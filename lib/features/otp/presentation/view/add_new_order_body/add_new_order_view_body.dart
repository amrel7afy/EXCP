        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              MyDropdownFormField<String>(
                labelText: 'اسم الحي',
                validator: (v) {},value: context.read<AddressCubit>().areaNameOptions.first,
              ...
              MyDropdownFormField<String>(
                ...
                validator: (v) {},
                value: context.read<AddressCubit>().houseTypeOptions.first,
              ...
              MyTextFormField(
                ...
                validator: (v) {},
                hint: 'رقم الجوال',
                hintStyle: MyTextStyles.font12Weight500.copyWith(color: MyColors.kPrimaryColor),
              ),
              MyTextFormField(
                maxLines: 6,
            ...
            SizedBox(
                ...
                child: CustomButton(textStyle: MyTextStyles.font18Weight500.copyWith(color: Colors.white), text: 'إرسال الطلب', onPressed: (){
                  context.pop();
                },),)
            ],
          ),
